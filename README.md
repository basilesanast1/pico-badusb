...
Congratulations. You just made yourself a BadUSB. Now copy your `payload.dd` file on the root folder of your Pico and after it is done, disconnect it from your computer immediatelly, or else the script you copied will run.
